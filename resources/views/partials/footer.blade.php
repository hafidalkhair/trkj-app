        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div>
                ...
                <ul class="text-slate-600 dark:text-slate-400 font-medium space-y-4">
                    ...
                    <li>
                        <a href="{{ route('contact') }}" class="hover:text-teal-600 dark:hover:text-teal-400 transition-colors inline-flex items-center group">
                            <span class="w-0 group-hover:w-2 h-0.5 bg-teal-600 mr-0 group-hover:mr-2 transition-all duration-300"></span>
                            Contact
                        </a>
                    </li>
            ...
            <div>
                ...
                <ul class="text-slate-600 dark:text-slate-400 font-medium space-y-4">
                    ...
                    <li class="flex items-center">
                        ...
                        <a href="mailto:trkjcopium@gmail.com" class="hover:text-teal-600 transition-colors">trkjcopium@gmail.com</a>
                    </li>
                </ul>
            </div>
            ...
            <div>
                ...
                <div class="flex space-x-4">
                    <a href="https://www.instagram.com/trkj_3copium/" target="_blank" class="w-10 h-10 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-500 hover:bg-teal-500 hover:text-white dark:hover:bg-teal-500 dark:hover:text-white transition-all duration-300 hover:-translate-y-1">
